...
download the latest prebuilt firmware from [releases](https://github.com/softmodded/marisko/releases), then flash it using the [solderless firmware utility](https://solderless.engineering) or [rome](https://github.com/softmodded/rome).
...
`marisko.bin` is the ready-to-flash firmware binary. grab it from [releases](https://github.com/softmodded/marisko/releases) or build from source (see [BUILDING.md](BUILDING.md)).
